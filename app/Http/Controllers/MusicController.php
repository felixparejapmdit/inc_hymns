...
$topCategories = Category::select('categories.*')
    ...
    ->get();
     ...
     return view('musics', compact('musics', 'churchHymns', 'categories', 'topCategories', 'instrumentations', 'ensemble_Types', 'languages', 'creators','lyricists', 'arrangers', 'composers'));
 }
