...
<x-app-layout>
        ...
        <div class="container" style="max-width: 1000px;">
            <div class="d-flex justify-content-between align-items-center mb-5 mt-2">
                <div>
                    ...
                    <p class="text-white opacity-80 font-bold uppercase tracking-wider small mt-1">Instruments & Arrangements</p>
                </div>
                    ...
                    <table class="table-modern">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 70%;">Instrumentation Name</th>
                            ...
                            @foreach($instrumentations as $index => $instrumentation)
                                <tr>
                                    <td class="text-center font-bold text-muted" style="font-size: 0.85rem;">
                                        {{ ($instrumentations->currentPage() - 1) * $instrumentations->perPage() + $loop->iteration }}
                                    </td>
                                    <td>
                                        <div class="font-black text-slate-800">{{ $instrumentation->name }}</div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            @if (\App\Helpers\AccessRightsHelper::checkPermission('instrumentations.edit') == 'inline')
                                                <button class="btn-icon edit-Instrumentation shadow-sm" 
                                                    data-toggle="modal" 
                                            ...
                                            @if (\App\Helpers\AccessRightsHelper::checkPermission('instrumentations.delete') == 'inline')
                                                <button class="btn-icon btn-delete delete-Instrumentation shadow-sm" 
    ...
    <div class="modal fade" id="addInstrumentationModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New Instrumentation</h5>
                ...
                <div class="modal-body p-4">
                    <form action="{{ route('instrumentations.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            <label class="font-bold small uppercase text-slate-500 mb-2">Instrumentation Name</label>
                            <input type="text" class="form-control rounded-pill-custom" name="name" required placeholder="e.g. SATB with Piano">
                        </div>
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary rounded-pill px-5 font-black uppercase shadow-lg">Create Instrumentation</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="editInstrumentationModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Instrumentation</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body p-4">
    ...
    <div class="modal fade" id="deleteInstrumentationModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="p-5 text-center">
                    ...
                    <p class="text-muted font-bold">You are about to delete <span id="del_name" class="text-danger"></span> instrumentation.</p>
    ...
    <script>
        ...
        $('.delete-Instrumentation').click(function() {
            ...
            $('#del_name').text(InstrumentationName);
            $('#deleteInstrumentationForm').attr('action', "{{ url('music_management/instrumentations') }}/" + InstrumentationId);
