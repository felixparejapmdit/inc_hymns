                ...
                <form action="{{ route('api_documentations.store') }}" method="POST">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" name="endpoint" id="endpoint" 
                               ...
                               placeholder="e.g. GET /api/musics/{id}" 
                               required>
                        <small class="text-slate-400 font-bold mt-2 d-block">Use format: METHOD /path/to/resource</small>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-5">
                        <a href="{{ route('api_documentations.index') }}" class="btn-cancel">
                            <i class="fas fa-times-circle mr-2"></i> Discard
                        </a>
                        <button type="submit" class="btn-submit">
                            <i class="fas fa-save mr-2"></i> Register Endpoint
                        </button>
                    </div>
                </form>
            </div>
