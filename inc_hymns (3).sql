...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2024 at 10:13 PM
...
(3, 34, 41, 0, '2024-06-12 23:17:25', '2024-06-12 23:17:25'),
...
CREATE TABLE `music_creators` (
  ...
  `music_background` varchar(1000) DEFAULT NULL,
...
--
-- Dumping data for table `music_language`
--

INSERT INTO `music_language` (`id`, `music_id`, `language_id`, `created_at`, `updated_at`) VALUES
(1, 71, 1, NULL, NULL),
(3, 71, 3, NULL, NULL);
